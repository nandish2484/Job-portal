          ...
          <div className='flex gap-2 mb-6 mt-3'>
            {
              ...
              <>
                ...
                <button onClick={updateResume} className='bg-green-100 rounded-lg border border-green-400 px-4 py-2'>Save</button>
              </>
          ...
          <table className='min-w-full bg-white border rounded-lg'>
            ...
            <tbody>
              {userApplications.map((job,index)=>true ? (
                <tr key={index}>
                  <td className='py-3 px-4 flex items-center gap-2 border-b'>{job.companyId.name}</td>
